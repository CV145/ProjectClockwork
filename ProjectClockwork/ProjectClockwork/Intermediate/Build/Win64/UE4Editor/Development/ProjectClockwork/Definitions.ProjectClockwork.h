...
#define UE_PROJECT_NAME ProjectClockwork
#define UE_TARGET_NAME ProjectClockworkEditor
#define UE_MODULE_NAME "ProjectClockwork"
...
#define PROJECTCLOCKWORK_API DLLEXPORT
